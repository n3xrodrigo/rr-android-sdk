...
public class PreferenceListActivity extends AppCompatActivity implements ActionBar.TabListener, PreferenceListFragment.LoadingListener {
        ...
        RichRelevance.buildGetUserPreferences(fieldType).setCallback(new Callback<UserPreferenceResponseInfo>() {
            ...
            public void onResult(final UserPreferenceResponseInfo result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if(result != null) {
                            PreferenceAdapter pagerAdapter = PreferenceListActivity.this.pagerAdapter;
